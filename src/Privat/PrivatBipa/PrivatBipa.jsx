...
const PrivatUtbk = () => {
  ...
  const [bipa, setBipa] = useState([]);

  useEffect(() => {
    fetchPrivatBipa();
  }, []);

  const fetchPrivatBipa = () => {
    fetch(`https://odd-puce-panther-tie.cyclic.app/api/privatbipa`)
      .then((res) => res.json())
      .then((data) => {
        setBipa(data.data);
        // console.log(data);
      ...
      <AnimatedPage>
        ...
        <div className="box-cpns">
          <h1 className="text-center">
            <strong>
              Les Privat BIPA (Bahasa Indonesia Bagi Penutur Asing)
            </strong>
          </h1>
        </div>
        ...
        <Container>
          <div className="content-cpns">
            <img
              className="img-islam"
              src="https://edumatrix-indonesia.com/wp-content/uploads/2023/04/CTA-3-800x801.jpg"
              alt=""
            />
            <div className="text-cpns">
              <h1>
                <strong>Mengenal Les Privat BIPA</strong>
              </h1>
              <h5 className="h5-cpns">
                <strong>Les privat BIPA</strong> (Bahasa Indonesia Bagi Penutur Asing)
                diperuntukan bagi masyarakat asing yang ingin belajar Bahasa
                Indonesia secara intens. Dengan dukungan master teacher
                profesional dan program pembelajaran intens, Edumatrix Indonesia
                adalah pilihan bimbel terbaik. Upgrade kemampuan Bahasa
                Indonesia dengan hanya memilih bimbel yang terpercaya.
              </h5>
          ...
          <div className="parent-bimpend">
            <h3 className="h3-bimpend">
              <strong>
                Keunggulan Memilih Les Privat untuk TK, SD, SMP, SMA & UTBK
                SNBT/SBMPTN
              </strong>
            </h3>
          ...
          <div className="program-supercamp">
            ...
            <div className="program-supercamp1">
              <Card style={{ border: "none" }} className="card-supercamp">
                <Card.Img
                  variant="top"
                  src="https://edumatrix-indonesia.com/wp-content/uploads/2023/03/Bahasa-Inggris-600x600.jpg"
                />
                <Card.Body className="card-edumatrix">
                  <Card.Title>
                    <strong>
                    Bimbel Privat Bahasa Inggris
                    </strong>
                  </Card.Title>
                  <br />
                  <a
                    href="https://web.whatsapp.com/send?phone=6281216365729&text=Halo%20Kak%20Aulia,%20saya%20ingin%20daftar%20Bimbel%20Privat%20Bahasa%20Inggris.%20Mohon%20info%20selengkapnya%20..."
              ...
              <Card style={{ border: "none" }} className="card-supercamp">
                <Card.Img
                  variant="top"
                  src="https://edumatrix-indonesia.com/wp-content/uploads/2023/03/Bahasa-Mandarin-600x600.jpg"
                />
                <Card.Body className="card-edumatrix">
                  <Card.Title>
                    <strong>Bimbel Privat Bahasa Mandarin</strong>
                  </Card.Title>
                  <br />
                  <a
                    href="https://web.whatsapp.com/send?phone=6281216365729&text=Halo%20Kak%20Aulia,%20saya%20ingin%20daftar%20Bimbel%20Privat%20Bahasa%20Mandarin.%20Mohon%20info%20selengkapnya%20..."
                    className="btn-chatnowsupercamp"
                  >
                    <strong>Chat Us Now!</strong>
                  </a>
              ...
              <Card style={{ border: "none" }} className="card-supercamp">
                <Card.Img
                  variant="top"
                  src="https://edumatrix-indonesia.com/wp-content/uploads/2023/03/Bahasa-Jerman-600x600.jpg"
                />
                <Card.Body className="card-edumatrix">
                  <Card.Title>
                    <strong>Bimbel Privat Bahasa Jerman</strong>
                  </Card.Title>
                  <br />
                  <a
                    href="https://web.whatsapp.com/send?phone=6281216365729&text=Halo%20Kak%20Aulia,%20saya%20ingin%20daftar%20Bimbel%20Privat%20Bahasa%20Jerman.%20Mohon%20info%20selengkapnya%20..."
                    className="btn-chatnowsupercamp"
                  >
                    <strong>Chat Us Now!</strong>
                  </a>
              ...
              <Card style={{ border: "none" }} className="card-supercamp">
                <Card.Img
                  variant="top"
                  src="https://edumatrix-indonesia.com/wp-content/uploads/2023/03/Bahasa-Jepang-600x600.jpg"
                />
                <Card.Body className="card-edumatrix">
                  <Card.Title>
                    <strong>Bimbel Privat Bahasa Jepang</strong>
                  </Card.Title>
                  <br />
                  <a
                    href="https://web.whatsapp.com/send?phone=6281216365729&text=Halo%20Kak%20Aulia,%20saya%20ingin%20daftar%20Bimbel%20Privat%20Bahasa%20Jepang.%20Mohon%20info%20selengkapnya%20..."
                    className="btn-chatnowsupercamp"
                  >
                    <strong>Chat Us Now!</strong>
                  </a>
