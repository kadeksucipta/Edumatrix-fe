...
const PrivatUtbk = () => {
  ...
  const fetchPrivatUtbk = () => {
    fetch(`https://odd-puce-panther-tie.cyclic.app/api/privatutbk`)
      .then((res) => res.json())
      .then((data) => {
        setUtbk(data.data);
        // console.log(data);
      ...
      <AnimatedPage>
        ...
        <div className="box-cpns">
          <h1 className="text-center">
            <strong>
              Les Privat TK, SD, SMP, SMA, UTBK SNBT/SBMPTN Terbaik
            </strong>
          </h1>
        </div>
        ...
        <Container>
          <div className="content-cpns">
            <img
              className="img-islam"
              src="https://edumatrix-indonesia.com/wp-content/uploads/2023/04/CTA-2.jpg"
              alt=""
            />
            <div className="text-cpns">
              <h1>
                <strong>
                  Mengenali Kebutuhan Belajar Lebih Intens pada TK, SD, SMP, SMA
                  & UTBK SNBT/SBMPTN
                </strong>
              </h1>
              <h5 className="h5-cpns">
                ...
                <br />
                <br />
                Tujuan tersebut bisa dicapai dengan mengikuti les privat
                terpercaya dan pastinya terbaik. Pilihlah les privat terbaik
                yang mampu menjawab setiap kebutuhan belajar siswa seperti{" "}
          ...
          <div className="program-supercamp">
            ...
            <div className="program-supercamp1">
              <Card style={{ border: "none" }} className="card-supercamp">
                <Card.Img
                  variant="top"
                  src="https://edumatrix-indonesia.com/wp-content/uploads/2023/04/SNBT-600x600.jpg"
                />
                <Card.Body className="card-edumatrix">
                  <Card.Title>
                    <strong>
                      Program Belajar Privat UTBK SNBT/SBMPTN 2023
                    </strong>
                  </Card.Title>
                  <br />
                  <a
                    href="https://web.whatsapp.com/send?phone=6281215523902&text=Halo%20Kak%20Eka,%20saya%20ingin%20daftar%20Program%20Belajar%20Privat%20UTBK%20SNBT/SBMPTN%202023.%20Mohon%20info%20selengkapnya%20...."
